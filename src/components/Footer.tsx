...
const [language, setLanguage] = React.useState<'en' | 'es' | 'bn'>('en');
...
<div className="mt-2 md:mt-0 flex items-center space-x-4">
              <div className="text-sm text-gray-400 flex items-center space-x-1">
                ...
                <select id="lang-select" value={language} onChange={(e) => setLanguage(e.target.value as any)} className="bg-gray-900 border border-gray-700 rounded px-2 py-1">
