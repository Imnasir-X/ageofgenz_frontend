...
const Header: React.FC = () => {
  ...
  const navLinkClasses = ({ isActive }: { isActive: boolean }): string => `transition-colors ${prefersReducedMotion ? 'duration-0' : 'duration-200 ease-out'} font-semibold uppercase tracking-wide line-clamp-1 ${isActive ? 'text-orange-500' : 'text-white'} hover:text-orange-500`;
